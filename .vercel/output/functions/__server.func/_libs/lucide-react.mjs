...
const Inbox = createLucideIcon("inbox", __iconNode$e);
const __iconNode$d = [
  [
    "path",
    {
...
const MailOpen = createLucideIcon("mail-open", __iconNode$c);
const __iconNode$b = [
...
const QrCode = createLucideIcon("qr-code", __iconNode$9);
const __iconNode$8 = [
...
const Shuffle = createLucideIcon("shuffle", __iconNode$5);
const __iconNode$4 = [
  [
    "path",
    {
