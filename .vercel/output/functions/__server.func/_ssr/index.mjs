...
import { w as parseRedirect, x as mergeHeaders, y as isRedirect, z as resolveManifestAssetLink, s as resolveManifestCssLink, k as rootRouteId, A as getNormalizedURL, C as getOrigin, D as waitForRequest, E as bindSsrResponseToRequest, F as normalizeSsrResponse, G as attachRouterServerSsrUtils, H as _getRenderedMatches, I as defineHandlerCallback, J as createSerializationAdapter, K as createRawStreamRPCPlugin, i as invariant, g as isNotFound, L as isResolvedRedirect, M as replaceSsrResponse, N as isSsrResponse, O as disposeSsrResponseDetached, P as executeRewriteInput, Q as stripSsrResponseBody, S as defaultSerovalPlugins, T as makeSerovalPlugin, p as getScriptPreloadAttrs, U as getStylesheetHref } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-XwTQiOv5.mjs");
...
const manifest = {
  "f7821b671deed829d42880a71156f951a1f688264a1a60d3ebdb34c3ec44daa1": {
    functionName: "fetchInbox_createServerFn_handler",
    importer: () => import("./inbox.functions-BIQ8UJ3u.mjs")
  }
};
